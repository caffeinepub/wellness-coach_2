...
export class Backend implements backendInterface {
    ...
    async getBookingByTime(arg0: Time): Promise<BookingRequest> {
        if (this.processError) {
            try {
                const result = await this.actor.getBookingByTime(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitBookingRequest(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitBookingRequest(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
